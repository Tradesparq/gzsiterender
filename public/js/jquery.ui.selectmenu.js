...
$.widget("ui.selectmenu", {
	...
	options: {
		...
		bgImage: function() {},
		wrapperElement: "",
		onItemMouseover: null // MARK: Change code for ts-plimportff.js by Jimmy 20111111
	},	
	...
	_init: function() {
//		alert("Init!" + this.element.attr('id'));
		var self = this, o = this.options;
		...
		for (var i = 0; i < selectOptionData.length; i++) {
			var thisLi = $('<li role="presentation"><a href="#" tabindex="-1" role="option" aria-selected="false">'+ selectOptionData[i].text +'</a></li>')
				...
				.bind('mouseover.selectmenu focus.selectmenu', function(){ 
					...
					if(o.onItemMouseover) o.onItemMouseover($(this)); // MARK: Change code for ts-plimportff.js by Jimmy 20111111
				})
				.bind('mouseout.selectmenu blur.selectmenu', function(){ 
